        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h5>В случае внештатной ситуации каждый зарегистрированный пользователь может заблокировать свою карту из личного кабинета<br/>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    а так же облегчает ведение финансовой деятельности компании.</h5>
                    <br/>
                    ...
                    <h5>При оплате проезда каждой картой считываются координаты места оплаты, тем самым в будующем
