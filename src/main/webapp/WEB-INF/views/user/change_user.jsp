...
<script type="text/javascript">
    function validate() {
        ...
        if (!re.test(y)) {
            document.getElementById("mobileNumberF").innerHTML = "*Номер телефона введен не верно, введите в формате +7XXXXXXXXXX";
            return false;
        }
...
<div class="container">
    ...
    <form:form name="form" method="POST" modelAttribute="person" onsubmit="return (validate())"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input type="text" path="firstName" id="firstName" class="form-control"/><span style="color:red"
                                                                                                    id="firstNameF"></span>
                <div class="has-error">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input type="text" path="lastName" id="lastName" class="form-control"/><span style="color:red"
                                                                                                  id="lastNameF"></span>
                <div class="has-error">
                        <span style="color:red">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input type="text" path="mobileNumber" id="mobileNumber" class="form-control"/><span
                    style="color:red" id="mobileNumberF"></span>
                <div class="has-error">
                        <span style="color:red">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="text-center">
                    <input type="submit" value="Изменить" class="btn btn-success" onClick="return validate();"
                           style="width: 100%"/>
                </div>
            </div>
            <div class="col-md-2">
