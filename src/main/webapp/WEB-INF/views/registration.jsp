 	...
 	<div class="generic-container">
		...
		<div class="well lead">User Registration Form</div>
	 	<form:form method="POST" modelAttribute="userForm" action="/registration/newUser" class="form-horizontal">
			...
			<%--<div class="row">--%>
				<%--<div class="form-group col-md-12">--%>
					<%--<label class="col-md-3 control-lable" for="rollers">Roles</label>--%>
					<%--<div class="col-md-7">--%>
						<%--<form:select path="rollers" items="${roles}" multiple="true" itemValue="id" itemLabel="type" class="form-control input-sm" />--%>
						<%--<div class="has-error">--%>
							<%--<form:errors path="rollers" class="help-inline"/>--%>
						<%--</div>--%>
					<%--</div>--%>
				<%--</div>--%>
			<%--</div>--%>
